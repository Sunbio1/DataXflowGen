...
#include <arInputFunctionsC.h>
 ...
 void fy_neu_data_2C6C200814D6F45EB0E9F79EC5041D83(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_neu_data_2C6C200814D6F45EB0E9F79EC5041D83(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 3.058175325834325E-2;
  ystd[it+nt*1] = 4.20892728529712E-2;
  ystd[it+nt*2] = 4.274865034967661E-2;
  ystd[it+nt*3] = 4.156016517376522E-2;
  ystd[it+nt*4] = 4.586913981951717E-2;
  ystd[it+nt*5] = 3.254994559438081E-2;

  return;
}


 void fsy_neu_data_2C6C200814D6F45EB0E9F79EC5041D83(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_neu_data_2C6C200814D6F45EB0E9F79EC5041D83(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
 ...
 void fy_scale_neu_data_2C6C200814D6F45EB0E9F79EC5041D83(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
