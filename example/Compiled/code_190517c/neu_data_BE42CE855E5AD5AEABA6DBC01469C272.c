...
#include <arInputFunctionsC.h>
 ...
 void fy_neu_data_BE42CE855E5AD5AEABA6DBC01469C272(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_neu_data_BE42CE855E5AD5AEABA6DBC01469C272(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 1.984694271606087E-2;
  ystd[it+nt*1] = 4.542420942086953E-2;
  ystd[it+nt*2] = 6.997056619241691E-2;
  ystd[it+nt*3] = 4.211123230943483E-2;
  ystd[it+nt*4] = 4.711455492276524E-2;
  ystd[it+nt*5] = 3.803143457032606E-2;

  return;
}


 void fsy_neu_data_BE42CE855E5AD5AEABA6DBC01469C272(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_neu_data_BE42CE855E5AD5AEABA6DBC01469C272(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
 ...
 void fy_scale_neu_data_BE42CE855E5AD5AEABA6DBC01469C272(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
