...
#include <arInputFunctionsC.h>
 ...
 void fy_neu_data_765854CC8C58746184D7F2BA78817CA4(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_neu_data_765854CC8C58746184D7F2BA78817CA4(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 5.546996708111779E-2;
  ystd[it+nt*1] = 4.936685212267668E-2;
  ystd[it+nt*2] = 4.437048468279526E-2;
  ystd[it+nt*3] = 5.093877351800041E-2;
  ystd[it+nt*4] = 5.162450550079457E-2;
  ystd[it+nt*5] = 5.570884544104208E-2;

  return;
}


 void fsy_neu_data_765854CC8C58746184D7F2BA78817CA4(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_neu_data_765854CC8C58746184D7F2BA78817CA4(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
 ...
 void fy_scale_neu_data_765854CC8C58746184D7F2BA78817CA4(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
