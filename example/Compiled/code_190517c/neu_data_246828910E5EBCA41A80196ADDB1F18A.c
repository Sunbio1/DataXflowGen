...
#include <arInputFunctionsC.h>
 ...
 void fystd_neu_data_246828910E5EBCA41A80196ADDB1F18A(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 1.907988244111804E-2;
  ystd[it+nt*1] = 4.223915520238107E-2;
  ystd[it+nt*2] = 6.550899470034177E-2;
  ystd[it+nt*3] = 5.316704491061928E-2;
  ystd[it+nt*4] = 4.680194336754841E-2;
  ystd[it+nt*5] = 3.13230021643796E-2;
