...
#include <arInputFunctionsC.h>
 ...
 void fy_neu_data_15A1F055C1DB84993186F02596F89DDC(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_neu_data_15A1F055C1DB84993186F02596F89DDC(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 1.648774423559031E-2;
  ystd[it+nt*1] = 4.308780062301822E-2;
  ystd[it+nt*2] = 6.178580552368646E-2;
  ystd[it+nt*3] = 4.574342202430799E-2;
  ystd[it+nt*4] = 4.520453181277372E-2;
  ystd[it+nt*5] = 3.584126919356714E-2;

  return;
}


 void fsy_neu_data_15A1F055C1DB84993186F02596F89DDC(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_neu_data_15A1F055C1DB84993186F02596F89DDC(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
 ...
 void fy_scale_neu_data_15A1F055C1DB84993186F02596F89DDC(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
