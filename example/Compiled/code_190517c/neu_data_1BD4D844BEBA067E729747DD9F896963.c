...
#include <arInputFunctionsC.h>
 ...
 void fy_neu_data_1BD4D844BEBA067E729747DD9F896963(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y, double *p, double *u, double *x, double *z){
 ...
 void fystd_neu_data_1BD4D844BEBA067E729747DD9F896963(double t, int nt, int it, int ntlink, int itlink, double *ystd, double *y, double *p, double *u, double *x, double *z){
  ystd[it+nt*0] = 2.213153274147564E-2;
  ystd[it+nt*1] = 3.799483553818953E-2;
  ystd[it+nt*2] = 4.906401831014735E-2;
  ystd[it+nt*3] = 4.758730593614092E-2;
  ystd[it+nt*4] = 4.164134985312128E-2;
  ystd[it+nt*5] = 4.219143864095833E-2;

  return;
}


 void fsy_neu_data_1BD4D844BEBA067E729747DD9F896963(double t, int nt, int it, int ntlink, int itlink, double *sy, double *p, double *u, double *x, double *z, double *su, double *sx, double *sz){
 ...
 void fsystd_neu_data_1BD4D844BEBA067E729747DD9F896963(double t, int nt, int it, int ntlink, int itlink, double *systd, double *p, double *y, double *u, double *x, double *z, double *sy, double *su, double *sx, double *sz){
 ...
 void fy_scale_neu_data_1BD4D844BEBA067E729747DD9F896963(double t, int nt, int it, int ntlink, int itlink, int ny, int nx, int nz, int iruns, double *y_scale, double *p, double *u, double *x, double *z, double *dfzdx){
